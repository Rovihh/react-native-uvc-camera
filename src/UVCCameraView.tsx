import {
  ...
  import UsbDeviceModule from './UVCDeviceModule';
  ...
  export const USBCamera: React.FC<USBCameraProps> = props => {
    ...
    useEffect(() => {
      ...
      //   //如果已经在设备列表中，则直接请求权限
      //   if (
      //     (await UsbDeviceModule.getDeviceList()).find(x => x.deviceId === Number(deviceId))
      //   ) {
      //     requestDevicePermission(Number(deviceId));
      //   }
      // })()
